...
function taskSchedulerFactory(
    ...
    TaskScheduler.prototype.createUpdateTaskDependenciesSubscription =
        function(taskHandlerStream, evaluateGraphStream, checkGraphFinishedStream) {
            console.log("1x1--taskHandlerStream")
            console.log(taskHandlerStream)
            console.log("1x1--evaluateGraphStream")
            console.log("1x1--checkGraphFinishedStream")
        var self = this;
    ...
    function _decorateRpc(client, method) {
        // console.log("1x1client1: ")
        // console.log(client)
        // console.log("1x1m1: " + method)
